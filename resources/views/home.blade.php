...
@section('content')
    ...
    <div class="container-fluid p-0" style="height: 3000px">
        ...
        <section class="row bg-primary position-relative justify-content-center about-section">
            <div id="blurb" class="col-sm-8 text-center">
                <h2>
                ...
                {{--</div>--}}
                <p>
                   I understand that the perfect application should look good and work even better. Beautiful design makes the world a better place.
                </p>
                <p>
